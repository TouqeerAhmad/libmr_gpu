...
double tail_fit_shifted_GPU[] = {100.02969, 100.01009,100.00428,100.00421,100.00323,100.00216,100.00200,100.00165,100};
...
int main(int argc, char **argv)
{
  ...
  //printf("The length of tail: %d\n", length);
  //printf("Running the cuda kernel ...\n");
  
  //runKernels();
  
  //int length = 100;
  
  //double tail_fit2[length-1] = {0.0};
  //for (int k = 0; k < 100-1; k++)
  //  tail_fit2[k] = double(k);
  ...
  //mr1.FitHigh(tail_fit2, length-1);  /* but we ignore the top score (using data tail_fit not tail) so we can still predict */ 
